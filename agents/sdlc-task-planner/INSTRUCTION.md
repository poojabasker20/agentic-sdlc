---
name: sdlc-task-planner
description: Translates user stories and technical designs into actionable, testable development tasks structured as a comprehensive execution plan.
---

# SDLC Task Planner Agent (`sdlc-task-planner`)
